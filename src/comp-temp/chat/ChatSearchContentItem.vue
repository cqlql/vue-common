<template>
  <div
    class="chat-search-content-item"
  >
    ...
    <div class="chat-search-content-item__right">
      ...
      <div class="chat-search-content-item__r-cont-wrap">
        <div class="chat-search-content-item__content" v-html="contentFinally" />
...
<script>
import showKeyWrod from '@/utils/show-key-word'
export default {
  data () {
    return {
      keyword: '你的西藏',
      content: '今日 @李秀1(你的西藏管家秀灵)     <b>全</b>体成员卫生轮值，请小组成员利用下班前15分钟进行打扫（老板办公室、办公区域、茶水间、卫生间、楼梯通道）'
    }
  },
  computed: {
    contentFinally () {
